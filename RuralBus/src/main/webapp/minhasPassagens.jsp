				...
				<table>
					...
					<tbody>
						<c:forEach var="passagem" items="${passagens}">
							<tr class="verPassagem"
								data-href="verPassagem.do?id=${passagem.id}">
								<td>${passagem.id}</td>
								<td>${passagem.viagem.partida}</td>
								<td>${passagem.viagem.destino}</td>
								<td><fmt:formatDate value="${passagem.viagem.data_partida}"
										pattern="dd/MM/yyyy HH:mm" /></td>
								<td><fmt:formatDate value="${passagem.viagem.data_chegada}"
										pattern="dd/MM/yyyy HH:mm" /></td>
