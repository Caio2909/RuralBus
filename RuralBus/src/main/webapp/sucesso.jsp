				...
				<div class="checkout-form">
					...
					<c:choose>
						<c:when test="${not empty passagem}">
							...
							<button onclick="window.location.href='Inicio.jsp'"
								class="btn-voltar">Voltar à Página Inicial</button>
						</c:when>
						<c:otherwise>
							<p style="color: red;">Erro: Não foi possível confirmar a
								compra. Por favor, tente novamente.</p>
							<button onclick="window.location.href='Inicio.jsp'"
								class="btn-voltar">Voltar para Seleção</button>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
