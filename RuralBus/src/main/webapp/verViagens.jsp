				...
				<form class="search-form" action="verViagens.do" method="get">
					...
					<div style="position: relative;">
						<input type="text" id="origin" name="origin"
							placeholder="Cidade de Origem" value="${param.origin}" required>
					...
					<div style="position: relative;">
						<input type="text" id="destination" name="destination"
							placeholder="Cidade de Destino" value="${param.destination}"
							required>
						<ul id="destinationDropdown" class="dropdown-list"></ul>
					</div>

					<label for="departure-date">Data de Ida:</label> <input type="date"
						id="departure-date" name="departureDate"
					...
					<tbody>
						<c:forEach var="viagem" items="${viagens}">
							<tr class="verPassagem" data-href="verViagem.do?id=${viagem.id}">
								...
								<td><fmt:formatDate value="${viagem.data_partida}"
										pattern="dd/MM/yyyy HH:mm" /></td>
								<td><fmt:formatDate value="${viagem.data_chegada}"
										pattern="dd/MM/yyyy HH:mm" /></td>
