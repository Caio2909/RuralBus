            ...
            <div class="checkout-layout">
                ...
                <div class="checkout-form">
                    ...
                    <form action="confirmarCompra.do" method="post">
                        ...
                        <input type="text" id="cpf" name="cpf" placeholder="Digite seu CPF" value="${usuarioLogado.CPF}" required readonly>
                     ...
                     <div class="checkout-details"> 
                    	<h2>Detalhes da Viagem</h2>
                     		<c:if test="${not empty viagem}">
							    <p><strong>Origem:</strong> ${viagem.partida}</p>
							    <p><strong>Destino:</strong> ${viagem.destino}</p>
							    <p><strong>Data de Partida:</strong> ${viagem.dataPartidaFormatada}</p>
							    <p><strong>Data de Chegada:</strong> ${viagem.dataChegadaFormatada}</p>
